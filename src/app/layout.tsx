...
export default function RootLayout({
    ...
    return (
        <html lang="de" suppressHydrationWarning>
            <body
                className={`${whyte.variable} relative bg-slate-100 font-sans text-slate-950 antialiased selection:bg-blue-500 selection:text-white dark:bg-black dark:text-slate-100`}
            >
                <ThemeProvider
                    attribute="class"
                    defaultTheme="system"
